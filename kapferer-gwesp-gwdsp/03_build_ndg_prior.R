...
# the Kapferer tailor-shop network under the egd model
#   y ~ edges + gwesp(0.25, fixed=TRUE) + gwdsp(0.25, fixed=TRUE).
#
...
# their (edges, gwesp, gwdsp) triples to disk. No convex hull is computed in
...
#
# The NDG prior hull/pool is 3D (edges, gwesp(0.25, fixed), gwdsp(0.25, fixed))
# as of Phase 5. hull3d.c reads these three columns directly as doubles.
